...
\cvsection[page1sidebar]{Formação Acadêmica}
    ...
    \cvevent{MBA - Cyber Security \& Ethical Hacking}{Faculdade de Informática e Administração Paulista (FIAP)}{[Cursando] 2020 -- 2021}{São Paulo - SP, Brasil}{}{}
    ...
    \begin{itemize}
        ...
        \item Avaliador  de projetos no Seminário de Física do INATEL (SEFITEL)
    \end{itemize}
...
\cvsection{Experiência Profissional}
    ...
    \cvevent{Engenheiro de Software Seguro - Offensive Security}{Samsung Instituto de Desenvolvimento para Informática (SiDi)}{2021 - Atual}{Campinas - SP, Brasil}{}{}
    % \cvevent{Engenheiro de Software Seguro}{SiDi}{2021 - Atual}{Campinas - SP, Brasil}{}{}
    \begin{itemize}
    ...
    \cvevent{Engenheiro de Software Seguro - DevSecOps}{Samsung Instituto de Desenvolvimento para Informática (SiDi)}{2018 - Atual}{Campinas - SP, Brasil}{}{}
    % \cvevent{Engenheiro de Software Seguro}{SiDi}{2018 - 2021}{Campinas - SP, Brasil}{}{}
    \begin{itemize}
